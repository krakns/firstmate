...
FM_NM_CUSTODY_MAX_AGE_SECS=21600  # oldest a pipeline-owned no-mistakes run may be and still bind without head equality; a run past it falls back to pane and status evidence so a stranded pipeline never reads as working
